...
//   return (
//     <>
//       <div className="flex items-center justify-center bg-image bg-1">
//         <div className="flex flex-col items-center max-w-4xl gap-20 p-8 rounded-lg md:flex-row">
//           <div className="text-center md:w-1/2 md:text-left">
//             <h1 className="text-5xl font-bold text-black">
//               Supporting You <br /> Every Step <br />
//               of the Way!
//             </h1>
//             <button
//               className="px-20 py-3 mt-6 font-semibold text-white bg-[#FF666A] hover:bg-[#FCBABC] rounded-full shadow "
...
//           <div className="flex mt-6 jusify-center md:w-1/2 md:mt-0">
//             <img
//               src={logo}
//               alt="Super Mom & Baby"
...
//       <div className="absolute right-0 top-[700px] rounded-3xl animate z-10"></div>

//       <div className="relative flex flex-col items-center justify-center min-h-screen ">
//         {/* النص والصورة */}
//         <div className="z-20 max-w-2xl text-center">
//           <h1 className="text-2xl font-semibold text-gray-800 md:text-3xl">
//             <strong>Start</strong> your parenting journey <strong>today</strong>{" "}
//             with <strong>confidence!</strong>
//           </h1>
//           <img
//             src={logo2}
//             alt="Cute Kids"
//             className="w-48 mx-auto mt-4 transform translate-x-24 md:w-64"
//           />
//         </div>
...
//           src={baby}
//           alt="Cloud"
//           className="absolute z-20 w-20 h-auto right-5 top-12"
//         />
//         <img
//           src={sky}
//           alt="Cake"
//           className="absolute z-20 w-16 h-auto left-5 top-15"
//         />

//         {/* الخدمات */}
//         <div className="grid w-full max-w-4xl grid-cols-1 gap-6 mt-10 text-center md:grid-cols-3">
//           {/* الخدمة 1 */}
//           <div className="flex p-4 bg-white rounded-lg shadow-lg">
//             <img src={logo3} alt="Babysitting" className="w-12 mx-auto" />
//             <div className="flex flex-col">
//               <h2 className="mt-2 font-semibold text-blue-950">Babysitting</h2>
//               <p className="text-sm text-gray-600">
//                 Provides a simple, trustworthy and extensive experience.
//               </p>
//             </div>
//           </div>
...
//           {/* الخدمة 2 */}
//           <div className="flex p-4 bg-white rounded-lg shadow-lg">
//             <img src={logo5} alt="Nanny Care" className="w-12 mx-auto" />
//             <div className="flex flex-col">
//               <h2 className="mt-2 font-semibold text-blue-950">Nanny Care</h2>
//               <p className="text-sm text-gray-600">
//                 A strategic, responsible and extensive childcare service.
//               </p>
//             </div>
//           </div>
...
//           {/* الخدمة 3 */}
//           <div className="flex p-4 bg-white rounded-lg shadow-lg">
//             <img src={logo4} alt="Mother's Helpers" className="w-12 mx-auto" />
//             <div className="flex flex-col">
//               <h2 className="mt-2 font-semibold text-blue-950">
//                 Mother’s Helpers
//               </h2>
//               <p className="text-sm text-gray-600">
//                 Provides simple, responsible, and effective ways.
//               </p>
//             </div>
//           </div>
//         </div>
...
//       <div className="container p-4 mx-auto bg-image bg-2">
//         <p className="text-xl text-center">
//           Discover{" "}
//           <span className="text-2xl font-bold">Essential Features</span> To
//           Support <br />
//           Your Journey as a{" "}
//           <span className="text-2xl font-bold"> New Mother</span>
//         </p>

//         <div className="grid grid-cols-1 gap-6 mt-60 md:grid-cols-3">
//           <div className="max-w-xs p-6 mx-5 bg-white rounded-lg shadow-2xl element hover-container card">
//             <img
//               src={todo}
//               alt="To-Do List"
//               className="object-cover w-full rounded-md h-100"
//             />
//             <h2 className="m-5 text-lg font-semibold leading-tight text-center">
//               Stay Organized with Our Comprehensive Daily To-Do List for New
//               Moms
//             </h2>
//             <p className="m-5 text-center text-gray-600">
//               Our To-Do List helps you manage daily tasks effortlessly, ensuring
//               you never miss a beat.
//             </p>
//             <a href="#" className="flex justify-center hover-text">
//               Learn More
//             </a>
//           </div>
...
//               className="object-cover w-full rounded-md h-100"
//             />
//             <h2 className="m-5 text-lg font-semibold text-center">
//               Quick Tips for New Moms to Navigate Early Parenthood With
//               Confidence
//             </h2>
//             <p className="m-5 text-center text-gray-600">
//               Get bite-sized advice that empowers you to make informed decisions
//               for your baby.
//             </p>
//             <a href="#" className="flex justify-center hover-text">
//               <br /> <br />
...
//           <div className="max-w-xs p-6 mx-1 bg-white rounded-lg shadow-2xl element hover-container card">
//             <img
//               src={steps}
//               alt="How-To Guides"
//               className="object-cover w-full rounded-md h-100"
//             />
//             <h2 className="m-5 text-lg font-semibold text-center">
//               Step-by-Step How-To-Guide for Every Aspect of Baby Care.
//             </h2>
//             <p className="m-5 text-center text-gray-600">
//               From feeding to bathing, our guides ensure you feel confident and
//               prepared.
//             </p>
//             <a href="#" className="flex justify-center text-center hover-text">
//               <br /> <br />
//               Get Started
//             </a>
//           </div>
...
//       <div className="flex flex-col items-center py-20 m-10 bg-image bg-3">
//         <h2 className="mb-6 text-2xl font-bold text-center text-slate-950">
//           Photo Gallery
//         </h2>
...
//             src={photo1}
//             alt="Baby Playing"
//             className="object-cover w-full h-40 transition-transform duration-300 rounded-lg hover:scale-125"
//           />
...
//           target="_blank"
//         >
//           <button className="px-6 py-2 mt-6 text-white bg-[#FF666A] hover:bg-[#FCBABC] rounded-lg rounded-l-none shadow-md ">
//             View More
//           </button>
//         </a>
//       </div>
