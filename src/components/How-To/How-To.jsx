...
// export default function HowTo() {
//   const tipsData = [
//     { id: 1, icon: bottle1, description: "Proper nutrition during a baby's first year is essential for healthy physical and mental development...", bgColor: "bg-[#f1e2a6]" },
//     { id: 2, icon: Sleeping, description: "Sleep is essential for your baby's healthy growth, as it supports brain development, boosts immunity...", bgColor: "bg-[#debcf1]" },
//     { id: 3, icon: Woman, description: "Spending time with your child and engaging in interactive activities enhances emotional connections...", bgColor: "bg-[#dac2a9]" },
//     { id: 4, icon: life, description: "Safety is the foundation for protecting your child from daily hazards. Ensure your home is safe...", bgColor: "bg-[#ecaab7]" },
//   ];
...
//         <img src={su} className="w-1/2 h-auto" alt="Super Mom" />
//       </div>
...
//           <div
//             key={tip.id}
//             className={`p-6 rounded-xl shadow-md hover:scale-105 cursor-pointer transition-transform duration-300 ${tip.bgColor}`}
//           >
//             <img src={tip.icon} alt="Icon" className="w-12 h-12 mb-4 mx-auto" />
//             <p className="text-sm text-center">{tip.description}</p>
//           </div>
//         ))}
//       </div>
